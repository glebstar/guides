...
$(document).ready(function(){
	...
	*/
	...
	$('.link-recom').hover(
		function(){$(this).not('.link-recom-active').addClass('link-recom-hover').html('����������!');},
		function(){$(this).not('.link-recom-active').removeClass('link-recom-hover').html('������������');}
	);
	$('.link-recom').click(function(){
		$('#pp-recom').overlay().css({left:getAbsolutePosition(this).x-206,top:getAbsolutePosition(this).y-26}).show();
        $(this).addClass('link-recom-active').html('����������!');        
		return false;
	});
	...
	$('.advice-tabs-table .advice-tabs-item a').click(function(){
		...
		/*if (!$(this).hasClass('advice-tabs-item-act') && $(this).text() == '������') {
			$(this).text('��������� ������').parent().siblings().find('a').text('�������');
		} else if (!$(this).hasClass('advice-tabs-item-act') && $(this).text() == '�������') {
			$(this).text('��������� �������').parent().siblings().find('a').text('������');
		}*/
		return false;
	});
